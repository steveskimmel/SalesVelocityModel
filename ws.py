...
class webService(Resource):
    ...
    def post(self):
        ...
        if 'calc_sales' in json_data:
            ...
            return SalesVelocityModel.new_sales_value_test(variables_dict['percentage_increase_deals'],variables_dict['percentage_increase_deal_size'],variables_dict['percentage_increase_win_rate'],variables_dict['percentage_increase_avg_sales_cycle'],variables_dict['current_deals'],variables_dict['current_deal_size'],variables_dict['current_win_rate'],variables_dict['current_avg_sales_cycle'])
